...
The agent sits at the center of that loop (manifest, guides, catalog, validate, plan, execute, and trace), deciding what to call and when; the order above is one common path, not a required sequence.
