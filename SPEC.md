...
|---|---|---|
| [Part I: Story and Positioning](./spec/part-i-story-and-positioning.md) | Informative | The three problems (learn, converge, scale), what Pilotage provides, scope, trust boundary, prior art, the LSP precedent, design decisions |
